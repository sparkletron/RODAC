...
%   \includepdf[pages=1,pagecommand=\subsection{TMS99XX Doxygen}]{dox/tms99XX/latex/refman.pdf}
%   \includepdf[pages=3-,pagecommand={}]{dox/tms99XX/latex/refman.pdf}
%   \input{LICENSE_8md}
%   \import{dox/tms99XX/latex/}{refmand}
%   \input{README_8md}
%   \input{tms99XX_8h}
%   \input{tms99XXascii_8h}
%   \input{tms99XXdatatypes_8h}
%   \input{tms99XXdefines_8h}
